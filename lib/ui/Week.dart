...
class _MyWeekState extends State<Week> {
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  Text(
                                    time +
                                        ', ' +
                                        forecastDaily.list[index].main.temp
                                            .toString() +
                                        ' ' +
                                        htmlDecode('&#176;') +
                                        'C',
                                  ...
                                  Text(
                                    'Humidity ' +
                                        forecastDaily.list[index].main.humidity
                                            .toString() +
                                        '%',
                                    style: TextStyle(
                                        color: Colors.deepPurple,
                            ...
                            Expanded(
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  Text(forecastDaily
                                      .list[index].weather[0].main, style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
                                  Text('(' +
                                      forecastDaily
